  ...
  const handleSubmit = async (continueCreating = false) => {
    ...
    try {
      ...
      if (continueCreating) {
        ...
        router.push("/organizacao/departamentos")
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-4xl">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Criar departamento</h1>
            <p className="text-slate-600">Adicione um novo departamento ao sistema</p>
          </div>
        </div>
        ...
        <Card className="shadow-lg border border-gray-200">
          ...
          <CardContent className="p-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Lista atual com design melhorado */}
          ...
          <div className="px-8 pb-8">
            <div className="flex items-center justify-between pt-6 border-t border-gray-200">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {isLoading ? "Criando..." : "Criar e adicionar outro"}
                </Button>
      ...
      {/* Modal de Código Promocional Melhorado */}
